...
## Project
Todo application with REST API, web UI, PostgreSQL, Docker Compose. Name of the app is "Valium",inspired by the Rolling Stone's Mother's little helper, Valium is your little helper for getting things done.
